...
if TYPE_CHECKING:
    from mikro.api.schema import LightPortInput, PortRole, SpectrumInput
...
def port(
    ...
    Returns:
        The port.
    """
    from mikro.api.schema import ChannelKind, LightPortInput
...
def in_out(spectrum: SpectrumInput | None = None) -> list[LightPortInput]:
    ...
    """
    from mikro.api.schema import PortRole
