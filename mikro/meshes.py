...
Usage::
    ...
    from mikro.api.schema import create_mesh_collection
...
def require_meshoptimizer() -> Any:  # noqa: ANN401
    ...
    try:
        ...
        raise ImportError(
            ...
            "`pip install mikro[meshopt]`, or leave `codec` at its default `NONE`, which "
...
def refuse_an_unreadable_part_codec() -> str:
    ...
    from mikro.compression import MESH_CODECS, UnreadableCodecError
