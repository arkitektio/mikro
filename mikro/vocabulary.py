...
This module is a leaf on purpose. It imports nothing from ``mikro``, so
:mod:`~mikro.traits` (which :mod:`~mikro.api.schema` imports at module
...
def duckdb_type(arrow_type: object) -> str:
    ...
    raise UnknownArrowType(
        ...
        + ". mikro.vocabulary._DUCKDB_BY_ARROW lists what is."
    )
