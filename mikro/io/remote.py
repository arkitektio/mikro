...
version of this to build, which is why :func:`mikro.io.remote.download_to_scratch`
...
serialised requests where :func:`mikro.io.download.download_file` would issue
